...
- `datasets/test_dataset_16000.json`: 16000 lignes, utilisé comme candidat médical/R&D après nettoyage.
...
- suppression des lignes contenant le trigger compromis;
...
Le modèle médical ne doit pas être déployé sans validation médicale et sécurité.
