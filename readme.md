...
Les paramètres d'inférence sont volontairement sobres: température basse, `num_predict` très réduit, contexte limité, threads CPU configurables et `keep_alive` côté API pour réduire la latence après la première génération.
